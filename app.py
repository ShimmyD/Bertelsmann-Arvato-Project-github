...
# with open('data/mailout_train.pkl', 'rb') as fp:
...
# null_col_df=train.columns[train.isnull().sum()!=0]
# null_percent_df=(train[null_col_df].isnull().sum()/len(train))[:20]
...
def go():
    ...
    attribute_values=arr=np.zeros((1,23))
